...
var require_compareByInspect = __commonJS({
  "node_modules/chai/lib/chai/utils/compareByInspect.js"(exports, module) {
    var inspect3 = require_inspect();
    module.exports = function compareByInspect(a2, b2) {
      return inspect3(a2) < inspect3(b2) ? -1 : 1;
    };
  }
});
...
function splitByComma(s2) {
  ...
  for (let i3 = 0; i3 < s2.length; i3++) {
    if (s2[i3] === "{" || s2[i3] === "[") {
      stack.push(s2[i3] === "{" ? "}" : "]");
    } else if (s2[i3] === stack[stack.length - 1]) {
      stack.pop();
...
function p() {
  ...
  if ((_a8 = globalThis.process) == null ? void 0 : _a8.env) for (const e of B) {
    const o = e[1] || e[0];
...
function E(e, t2, n2) {
  ...
  let O2 = (h) => {
    ...
    r2 !== "value" && delete w2.writable, w2[r2] = h, f(e, s2, w2);
  }, K = () => a2 ? f(e, s2, a2) : O2(o), T2 = y2[c2];
  return i2(T2, "restore", K), i2(T2, "getOriginal", () => l2 ? o() : o), i2(T2, "willCall", (h) => (T2.impl = h, y2)), O2(l2 ? () => (P2(y2, n2), y2) : y2), g.add(y2), y2;
}
...
function eq(a2, b2, aStack, bStack, customTesters, hasKey2) {
  ...
  for (let i3 = 0; i3 < customTesters.length; i3++) {
    const customTesterResult = customTesters[i3].call(testerContext, a2, b2, customTesters);
    if (customTesterResult !== void 0)
      return customTesterResult;
  }
  if (a2 instanceof Error && b2 instanceof Error)
    return a2.message === b2.message;
  ...
  aStack.push(a2);
  bStack.push(b2);
  if (className2 === "[object Array]" && a2.length !== b2.length)
    return false;
  ...
  while (size--) {
    key = aKeys[size];
    result = hasKey2(b2, key) && eq(a2[key], b2[key], aStack, bStack, customTesters, hasKey2);
    if (!result)
      return false;
  }
  aStack.pop();
...
function getObjectKeys(object2) {
  return [
    ...
    ...Object.getOwnPropertySymbols(object2).filter(
      (s2) => {
        var _a8;
        return (_a8 = Object.getOwnPropertyDescriptor(object2, s2)) == null ? void 0 : _a8.enumerable;
      }
    )
  ];
}
...
function sortComparator$12(a2, b2) {
  return a2[0] - b2[0];
}
var schemeRegex = /^[\w+.-]+:\/\//;
var urlRegex = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/;
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-JR6BZE5N.js")).default;
...
var MockDate = class _MockDate extends RealDate {
  constructor(y2, m2, d2, h, M3, s2, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s2 = s2 || 0;
        ms = ms || 0;
        date = new RealDate(y2, m2, d2, h, M3, s2, ms);
        break;
    }
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
  ...
  function compareTimers(a2, b2) {
    if (a2.callAt < b2.callAt) {
      return -1;
    }
    if (a2.callAt > b2.callAt) {
      return 1;
    }
    if (a2.immediate && !b2.immediate) {
      return -1;
    }
    if (!a2.immediate && b2.immediate) {
      return 1;
    }
    if (a2.createdAt < b2.createdAt) {
      return -1;
    }
    if (a2.createdAt > b2.createdAt) {
      return 1;
