...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'projetos',
    media: [
      { url: getAssetUrl('videos/portimages/projetos/projetos1.jpeg'), type: 'image' },
      { url: getAssetUrl('videos/portvideos/projetos/projetos2.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portimages/projetos/projetos3.jpeg'), type: 'image' },
      { url: getAssetUrl('videos/portvideos/projetos/projetos4.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portimages/projetos/projetos5.jpeg'), type: 'image' },
      { url: getAssetUrl('videos/portvideos/projetos/projetos6.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portimages/projetos/projetos7.jpeg'), type: 'image' },
      { url: getAssetUrl('videos/portvideos/projetos/projetos8.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portimages/projetos/projetos9.jpeg'), type: 'image' },
