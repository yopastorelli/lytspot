...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'projetos',
    media: [
      { url: getAssetUrl('videos/portfolio/portvideos/projetos1.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portfolio/portvideos/projetos2.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portfolio/portvideos/projetos3.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portfolio/portvideos/projetos4.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portfolio/portvideos/projetos6.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portfolio/portvideos/projetos5.mp4'), type: 'video' },
    ],
