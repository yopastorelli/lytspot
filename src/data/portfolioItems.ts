...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'projetos',
    media: [
      { url: getAssetUrl('videos/portvideos/projetos1.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portvideos/projetos2.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portvideos/projetos3.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portvideos/projetos4.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portvideos/projetos6.mp4'), type: 'video' },
      { url: getAssetUrl('videos/portvideos/projetos5.mp4'), type: 'video' },
    ],
